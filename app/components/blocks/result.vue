<template>
    <section class="result wrapper">
        <div class="result-content">
            ...
            <h2 id="result__title--1" class="result__title title-h2">Почему нам доверяют бизнес?</h2>
            ...
            <h2 id="result__title--2" class="result__title title-h3">Результаты в цифрах:</h2>
            <ul class="result__list">
                <li class="result__list-item text-medium">В среднем запускаем проект за 14 рабочих дней</li>
                <li class="result__list-item text-medium">Помогаем клиентам сэкономить до 30% бюджета на автоматизации</li>
            </ul>
        ...
        <div class="result-gecorate">
            <div class="result__image-container">
                <div class="result__image-mask">
                    <img 
                        class="result__image" 
                        src="@/assets/sprites/woman-star.svg" 
                        alt="woman-star.svg"
                    >
                </div>
            </div>
